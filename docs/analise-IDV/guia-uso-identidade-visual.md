...
--color-primary-red: #ff4d2d /* Laranja - Calor humano, alegria, festival */
  --color-primary-orange: #ff9d28 /* Índigo - Profundidade, contraste elegante */
...
--color-secondary-green: #006a47 /* Teal - Moderno, tecnológico */ --color-secondary-teal: #007b9a;
```
...
--color-neutral-cream: #fefbdf /* Branco */ --color-neutral-white: #ffffff /* Preto */
...
```css
/* Texto */
--color-text-primary: #1e1876 /* Índigo */ --color-text-secondary: #006a47 /* Verde */
  --color-text-light: #fefbdf /* Creme */ /* Backgrounds */ --color-bg-primary: #fefbdf /* Creme */
  --color-bg-dark: #1e1876 /* Índigo */ --color-bg-accent: #ff4d2d /* Vermelho */;
```
...
```html
<h1 class="font-display text-5xl text-white md:text-6xl lg:text-7xl">STL Festival 2026</h1>
```

**CTA Button**

```html
<button class="font-display bg-primary-red px-8 py-4 text-xl text-white">Comprar Ingressos</button>
```

**Corpo de Texto**

```html
<p class="text-text-primary font-body text-base">O STL Festival é mais do que música...</p>
```
...
```html
<button
  class="font-display bg-primary-red rounded-lg px-8 py-4 text-xl text-white transition-all hover:bg-opacity-90"
>
  Comprar Ingressos
</button>
```
...
```html
<button
  class="font-display text-primary-indigo border-primary-indigo hover:bg-primary-indigo rounded-lg border-2 bg-transparent px-6 py-3 text-lg transition-all hover:text-white"
>
  Saiba Mais
</button>
```
...
<div class="rounded-xl bg-white p-6 shadow-lg">
  <h3 class="font-display text-primary-indigo mb-4 text-2xl">Título</h3>
  <p class="text-text-primary font-body text-base">Conteúdo...</p>
</div>
```
...
```html
<span class="font-display bg-primary-orange rounded-full px-4 py-2 text-sm text-white"> Novo </span>
```
